...
class UiCleanupR8Tests(unittest.TestCase):
    ...
    def test_mobile_hardening_keeps_real_touch_targets_and_bounded_search_grid(self):
        ...
        self.assertIn('#largeSearchPanel.large-search{grid-template-columns:minmax(0,1fr) minmax(0,1fr)!important', source)
        self.assertIn('#largeSearchPanel.large-search>*{min-width:0;max-width:100%}', source)
        self.assertIn('#largeSearchPanel>#largeSearchStatus', source)
