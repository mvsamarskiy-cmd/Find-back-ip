...
class TurboSearchUiTests(unittest.TestCase):
    ...
    def test_turbo_ui_never_relabels_unconfirmed_as_free(self):
        ...
        self.assertIn('100% підтверджено вільний', source)
        self.assertIn('Хоч 1 канал без зайнятості', source)
        self.assertIn('усі кандидати залишаються в «Результатах»', source)
