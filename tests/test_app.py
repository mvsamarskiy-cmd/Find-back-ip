...
class AppTests(unittest.TestCase):
    ...
    def test_home_contains_project_feedback_controls(self):
        ...
        self.assertIn("AI brand discovery · v5.1", body)
        self.assertIn("Opportunity score", body)
        self.assertIn("bundle_score", body)
        self.assertIn("required_score", body)
        self.assertIn("optional_score", body)
        self.assertIn("familyLabels", body)
