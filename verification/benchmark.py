...
KNOWN_FIXTURES = (
    ...
    Fixture("mazomoto", "telegram", "exists", "Known Telegram handle from prior manual verification"),
    Fixture("telegram", "telegram", "exists", "Official Telegram public channel username"),
    Fixture("durov", "telegram", "exists", "Telegram founder public username used in official t.me examples/posts"),
    Fixture("username", "telegram", "exists", "Official Telegram Usernames public channel"),
